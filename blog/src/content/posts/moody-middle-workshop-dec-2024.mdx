...
date: "2024-12-08"
excerpt: "Our youth-led team delivered hands-on engineering and coding sessions for Grade 7–8 students at Moody Middle School, featuring an earthquake-tower challenge and an introduction to Python Turtle graphics."
author: "Diwen Huang"
...
On December 8th, 2024, Stemsphere brought a full **90-minute STEM workshop** to **Moody Middle School**. Our youth-led team — **Diwen, Zoe, Tristan, Eden, Hao, and Drishya** — guided Grade 7–8 students through two interactive sessions: a **Python Turtle coding lesson** and an **Earthquake Tower Engineering Challenge**.
