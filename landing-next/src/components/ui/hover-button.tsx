    ...
    ({ className, children, ...props }, ref) => {
        ...
        return (
            <button
                ref={buttonRef}
                className={cn(
                    "relative isolate px-10 py-3 rounded-full",
                    "text-white font-medium text-base leading-6",
                    "backdrop-blur-lg bg-emerald-500/10",
                    "border border-emerald-500/30",
                    "cursor-pointer overflow-hidden",
                    "before:content-[''] before:absolute before:inset-0",
                    "before:rounded-[inherit] before:pointer-events-none",
                    "before:z-[1]",
                    "before:shadow-[inset_0_0_0_1px_rgba(16,185,129,0.2),inset_0_0_16px_0_rgba(16,185,129,0.1),inset_0_-3px_12px_0_rgba(16,185,129,0.15),0_1px_3px_0_rgba(0,0,0,0.50),0_4px_12px_0_rgba(0,0,0,0.45)]",
